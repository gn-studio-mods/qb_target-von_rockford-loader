...
local isEtageLoaded = false

RegisterNetEvent('qb-hotels:client:LoadEtage', function(data)
	if data == 'Lobby' then
		UnloadIpl()
		isEtageLoaded = false
	elseif data == 'Floor 1' and not isEtageLoaded then
		loadEtage1()
		isEtageLoaded = true
	elseif data == 'Floor 2' and not isEtageLoaded then
		loadEtage2()
		isEtageLoaded = true
	elseif data == 'Floor 3' and not isEtageLoaded then
		loadEtage3()
		isEtageLoaded = true
	elseif data == 'Floor 4' and not isEtageLoaded then
		loadEtage4()
		isEtageLoaded = true
	elseif data == 'Floor 5' and not isEtageLoaded then
		loadEtage5()
		isEtageLoaded = true
	elseif data == 'Floor 6' and not isEtageLoaded then
		loadEtage6()
		isEtageLoaded = true
	elseif data == 'Floor 7' and not isEtageLoaded then
		loadEtage7()
		isEtageLoaded = true
	end
end)